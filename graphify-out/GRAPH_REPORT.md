...
- [[_COMMUNITY_aiActions.ts|aiActions.ts]]
- [[_COMMUNITY_Alipay Transaction Parser|Alipay Transaction Parser]]
- [[_COMMUNITY_Parse Pagination Query|Parse Pagination Query]]
- [[_COMMUNITY_React SVG Logo Asset|React SVG Logo Asset]]
- [[_COMMUNITY_P1-G-00 Remains REFACTORED and AT_RISK|P1-G-00 Remains REFACTORED and AT_RISK]]
- [[_COMMUNITY_mapPrismaError()|mapPrismaError()]]
- [[_COMMUNITY_ImportPage|ImportPage]]
...
- [[_COMMUNITY_Prisma Financial-Mutation Adapter Contract Tests|Prisma Financial-Mutation Adapter Contract Tests]]
- [[_COMMUNITY_familyAccess.ts|familyAccess.ts]]
...
- [[_COMMUNITY_VALIDATION_FAILED for an empty or whitespace-only resourceId|VALIDATION_FAILED for an empty or whitespace-only resourceId]]
...
- [[_COMMUNITY_ImportPage.tsx|ImportPage.tsx]]
...
- [[_COMMUNITY_ui_smoke.py|ui_smoke.py]]
...
- [[_COMMUNITY_Only Exact RUN_INTEGRATION=1 Enables Database Tests|Only Exact RUN_INTEGRATION=1 Enables Database Tests]]
- [[_COMMUNITY_P1-B-04 Raw Prisma Error Cause|P1-B-04 Raw Prisma Error Cause]]
- [[_COMMUNITY_AIPage.test.tsx|AIPage.test.tsx]]
...
- [[_COMMUNITY_expenses.ts|expenses.ts]]
- [[_COMMUNITY_export.test.ts|export.test.ts]]
- [[_COMMUNITY_families.test.ts|families.test.ts]]
- [[_COMMUNITY_files.test.ts|files.test.ts]]
- [[_COMMUNITY_goals.test.ts|goals.test.ts]]
- [[_COMMUNITY_goals.ts|goals.ts]]
- [[_COMMUNITY_import.test.ts|import.test.ts]]
- [[_COMMUNITY_import.ts|import.ts]]
- [[_COMMUNITY_incomes.ts|incomes.ts]]
- [[_COMMUNITY_liabilities.ts|liabilities.ts]]
- [[_COMMUNITY_recurring.test.ts|recurring.test.ts]]
- [[_COMMUNITY_recurring.ts|recurring.ts]]
...
- [[_COMMUNITY_P1-B-02 coordinator focused tests PASS 1414|P1-B-02 coordinator focused tests PASS 14/14]]
- [[_COMMUNITY_P1-B-01 schema and migration PASS-REAL|P1-B-01 schema and migration PASS-REAL]]
- [[_COMMUNITY_Internal MinIO Client|Internal MinIO Client]]
- [[_COMMUNITY_ImportPage.test.tsx|ImportPage.test.tsx]]
...
- [[_COMMUNITY_PostgreSQL Revision Survives Redis Outage and Restart|PostgreSQL Revision Survives Redis Outage and Restart]]
...
- [[_COMMUNITY_Server Owns Startup, Shutdown, and External Initialization|Server Owns Startup, Shutdown, and External Initialization]]
- [[_COMMUNITY_ImportrecurringAI mutation adoption remains open|Import/recurring/AI mutation adoption remains open]]
- [[_COMMUNITY_Populated upgraderestore remains unverified|Populated upgrade/restore remains unverified]]
- [[_COMMUNITY_Stagingrelease observation remains open|Staging/release observation remains open]]
- [[_COMMUNITY_P1-0-05 ADR-00010002 contract accepted (decision evidence)|P1-0-05 ADR-0001/0002 contract accepted (decision evidence)]]
- [[_COMMUNITY_Income or Expense Ledger Fact|Income or Expense Ledger Fact]]
- [[_COMMUNITY_P1-A-03 PASS-MOCK Evidence|P1-A-03 PASS-MOCK Evidence]]
- [[_COMMUNITY_Global Branch and Function Coverage Gate|Global Branch and Function Coverage Gate]]
- [[_COMMUNITY_P1-B-04 raw Prisma error capture required|P1-B-04 raw Prisma error capture required]]
- [[_COMMUNITY_Unclassified Real-Failure Risk|Unclassified Real-Failure Risk]]
- [[_COMMUNITY_minio.test.ts|minio.test.ts]]
- [[_COMMUNITY_server.test.ts|server.test.ts]]
- [[_COMMUNITY_MinIO startup failure propagation|MinIO startup failure propagation]]
...
4. `P1-B-05 revision and idempotency consistency verification` - 10 edges
5. `Financial Write Integrity Analysis` - 8 edges
6. `Ledger Application Boundary` - 8 edges
7. `Reusable SVG Icon Symbol Sprite` - 8 edges
...
### Community 14 - "financialMutationCoordinator.ts"
Cohesion: 0.33
...
### Community 15 - "Ledger Application Service"
Cohesion: 0.24
...
- **Thin community `familyCache.ts`** (2 nodes): `familyCache.ts`, `familyReportCacheKey()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `checkFamilyAccess()`** (2 nodes): `checkFamilyAccess()`, `assets.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `compare.ts`** (2 nodes): `compare.ts`, `sumAmount()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `expenses.ts`** (2 nodes): `expenses.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `families.test.ts`** (2 nodes): `families.test.ts`, `createToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `files.test.ts`** (2 nodes): `files.test.ts`, `createToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `goals.test.ts`** (2 nodes): `goals.test.ts`, `createToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `goals.ts`** (2 nodes): `goals.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `import.test.ts`** (2 nodes): `import.test.ts`, `createToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `import.ts`** (2 nodes): `import.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `incomes.ts`** (2 nodes): `incomes.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `liabilities.ts`** (2 nodes): `liabilities.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `recurring.test.ts`** (2 nodes): `recurring.test.ts`, `createToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `recurring.ts`** (2 nodes): `recurring.ts`, `checkFamilyAccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Focused RED-GREEN-REFACTOR Workflow`** (2 nodes): `Focused RED-GREEN-REFACTOR Workflow`, `Executable CI Quality Gates`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Auditability Precedes More Generative AI Rationale`** (2 nodes): `Auditability Precedes More Generative AI Rationale`, `Immutable Audit Trail and Reconciliation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-A-02 Evidence Is PASS-MOCK`** (2 nodes): `P1-A-02 Evidence Is PASS-MOCK`, `ADR-0001 and ADR-0002 Remain Proposed References`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-B-02 coordinator focused tests PASS 14/14`** (2 nodes): `P1-B-02 coordinator focused tests PASS 14/14`, `P1-B-02 pure coordinator contract remains PASS-MOCK`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-B-01 schema and migration PASS-REAL`** (2 nodes): `P1-B-01 schema and migration PASS-REAL`, `P1-G-01 PostgreSQL migration and rollback primitives PASS-REAL`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Internal MinIO Client`** (2 nodes): `Internal MinIO Client`, `MinIO Object Storage Lifecycle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `ImportPage.test.tsx`** (2 nodes): `ImportPage.test.tsx`, `deferred()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Cache Rollback Must Preserve Authorization`** (1 nodes): `Cache Rollback Must Preserve Authorization`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `PostgreSQL Revision Survives Redis Outage and Restart`** (1 nodes): `PostgreSQL Revision Survives Redis Outage and Restart`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Server Owns Process Lifecycle`** (1 nodes): `Server Owns Process Lifecycle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Database-First Idempotency and Concurrency Plan`** (1 nodes): `Database-First Idempotency and Concurrency Plan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Server Owns Startup, Shutdown, and External Initialization`** (1 nodes): `Server Owns Startup, Shutdown, and External Initialization`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Import/recurring/AI mutation adoption remains open`** (1 nodes): `Import/recurring/AI mutation adoption remains open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Populated upgrade/restore remains unverified`** (1 nodes): `Populated upgrade/restore remains unverified`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Staging/release observation remains open`** (1 nodes): `Staging/release observation remains open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-0-05 ADR-0001/0002 contract accepted (decision evidence)`** (1 nodes): `P1-0-05 ADR-0001/0002 contract accepted (decision evidence)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Income or Expense Ledger Fact`** (1 nodes): `Income or Expense Ledger Fact`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-A-03 PASS-MOCK Evidence`** (1 nodes): `P1-A-03 PASS-MOCK Evidence`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Global Branch and Function Coverage Gate`** (1 nodes): `Global Branch and Function Coverage Gate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `P1-B-04 raw Prisma error capture required`** (1 nodes): `P1-B-04 raw Prisma error capture required`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Unclassified Real-Failure Risk`** (1 nodes): `Unclassified Real-Failure Risk`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `minio.test.ts`** (1 nodes): `minio.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `server.test.ts`** (1 nodes): `server.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `MinIO startup failure propagation`** (1 nodes): `MinIO startup failure propagation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
