...
| Atomic transaction generation | Imports, recurring, and AI writes are atomic/idempotent | Import batch confirm now uses a transaction-backed Ledger path with local PostgreSQL atomic/replay/concurrency evidence; recurring and AI remain open |
