...
| backend coverage | FAILED | 34 suites / 295 tests 通过；本轮 coverage 为 statements 63.71%、branches 47.10%、functions 64.06%、lines 64.00%，全局 branch threshold 60% 未达标；OCR/MinIO fixtures 有既有 console.warn |
