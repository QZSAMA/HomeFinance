...
- 快照补充（2026-09-03，P1-F 币种/对账基础）：`7af352b` 新增 Decimal-safe `currencySummaryService` 与 `reconciliation` 纯服务；focused 2 suites / 7 tests 和后端 coverage 54 suites / 451 tests（statements 77.27%、branches 61.33%、functions 73.47%、lines 78.24%）通过。服务尚未接入报表、预算、compare、Balance、goals，故 P1-F-03/P1-F-04/P1-F-05 仍未关闭。
