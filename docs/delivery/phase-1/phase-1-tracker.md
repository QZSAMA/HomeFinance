...
| P1-G-00 | TASK | P1-G | 分离 app/server/db 启动边界 | P0 | RED_REPRODUCED | ON_TRACK | Delivery DRI | Technical Approver | hard:P1-0-03@DONE | app import 无 listener/Redis/MinIO 副作用 | evidence/P1-G-00.md | ADR-0001 | RED 已证实：`backend/src/app.test.ts` / `imports without opening a listener or initializing external services`; 进入最小 app/server/db 拆分 | 2026-08-28 |
