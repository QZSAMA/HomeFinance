...
| backend coverage | PASS-REAL | 当前 coverage 执行 50 suites / 411 tests，所有行为断言通过；statements 75.61%、branches 60.14%、functions 71.42%、lines 76.40%，达到未降低的全局 60% threshold；OCR/MinIO fixtures 有既有 console.warn |
