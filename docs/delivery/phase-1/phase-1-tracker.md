...
| P1-G-00 | TASK | P1-G | 分离 app/server/db 启动边界 | P0 | BACKLOG | ON_TRACK | Delivery DRI | Technical Approver | hard:P1-0-03@DONE | app import 无 listener/Redis/MinIO 副作用 | evidence/P1-G-00.md | ADR-0001 | 保留 server adapter；写 isolation RED | 2026-08-28 |
